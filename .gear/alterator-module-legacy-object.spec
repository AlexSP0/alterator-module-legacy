...
%changelog
* Mon Nov 13 2023 Aleksey Saprunov <sav@altlinux.org> 0.1.3-alt1
- change interface name from object to legacy

* Mon Oct 30 2023 Aleksey Saprunov <sav@altlinux.org> 0.1.2-alt1
- add internal module name
